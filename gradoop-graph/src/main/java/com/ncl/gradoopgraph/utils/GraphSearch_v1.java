...
public class GraphSearch_v1 {
    ...
    /*
    方法首先从给定的图中提取所有的节点和边，然后构建出图的邻接表。之后，它找出所有没有入边的节点，将它们作为路径的起始节点。
     */
    public static void findAllSimplePaths(LogicalGraph graph, DataSet<EPGMVertex> sortedVertices) throws Exception {
